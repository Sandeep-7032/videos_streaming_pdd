...
if (!empty($selected_videos)) {
    ...
    $query = "SELECT video_title, video_url FROM videos WHERE video_title IN ($placeholders) AND category_name = 'Youngers'";
